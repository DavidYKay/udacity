...
def top_k(L, k):
  ...
  if len(left) == k:
    ...
    return left
  if len(left) <= k and len(left) + len(middle) >= k:
    numMidsToGrab = k - len(left)
    grabbed = middle[0:numMidsToGrab]
...
class TestSequenceFunctions(unittest.TestCase):
  ...
  def test_easy(self):
    example = [1, 2, 3, 4]
    self.assertEqual(minimize_absolute(example), 2.5)

  def test_choice(self):
    example = [-3, 0, 1, 7]
    self.assertEqual(minimize_absolute(example), 0.5)


  def test_no_duplicates_even(self):
    example = [-500, -490, -475, -464, -456, -449, -443, -424, -416, -402, -383, -352, -344, -342, -328, -321, -296, -293, -280, -278, -268, -262, -259, -234, -207, -181, -178, -175, -160, -155, -154, -128, -108, -102, -100, -98, -92, -84, -81,
    -62, -49, -39, -36, -33, -20, -14, -10, -9, -1, 2, 4, 7, 26, 27, 48, 83, 84, 87, 91, 95, 103, 106, 112, 135, 140, 149, 179, 184, 187, 196, 211, 217, 222, 226, 240, 247, 257, 270, 274, 279, 289, 302, 303, 309, 320, 334, 337, 347, 351, 352, 362, 373, 394, 411,
    433, 444, 455, 475, 485, 486]
    expected_median = 3
    self.assertEqual(len(example), 100)
    self.assertEqual(len(set(example)), 100)
    self.assertEqual(minimize_absolute(example), expected_median)

  def test_no_duplicates_odd(self):
    example = [-500, -490, -475, -464, -456, -449, -443, -424, -416, -402, -383, -352, -344, -342, -328, -321, -296, -293, -280, -278, -268, -262, -259, -234, -207, -181, -178, -175, -160, -155, -154, -128, -108, -102, -100, -98, -92, -84, -81,
    -62, -49, -39, -36, -33, -20, -14, -10, -9, -1, 2, 4, 7, 26, 27, 48, 83, 84, 87, 91, 95, 103, 106, 112, 135, 140, 149, 179, 184, 187, 196, 211, 217, 222, 226, 240, 247, 257, 270, 274, 279, 289, 302, 303, 309, 320, 334, 337, 347, 351, 352, 362, 373, 394, 411,
    433, 444, 455, 475, 485]
    expected_median = 2
    self.assertEqual(len(example), 99)
